...
export default function Pricing() {
  return (
    <section className="py-12 overflow-hidden text-white bg-[#1D342A]">
      <div className="container px-4 mx-auto ">
        <div className="mb-20 md:max-w-2xl text-center mx-auto">
          <h2 className="font-sans mb-8 text-3xl lg:text-4xl text-white tracking-7xl lg:tracking-4xl font-semibold">
            Invista na transformação de sua vida e na construção de um legado
            duradouro:
          </h2>
        </div>
        <div className=" flex   justify-center items-center  flex-wrap -m-4 text-xl font-sans text-center   gap-8">
        ...
        <div className="flex flex-col gap-8 text-xl justify-center items-center font-sans font-semibold text-center py-10">
          ...
          <Link
            className="inline-block max-w-md   lg:w-1/2 text-center  p-2 tracking-tighter border- bg-orange-500 hover:bg-orange-400  text-primary-500 focus:ring-4 focus:ring-orange-400 focus:ring-opacity-40 font-sans font-bold text-md lg:text-xl uppercase rounded-full transition duration-300"
            href="#"
          >
